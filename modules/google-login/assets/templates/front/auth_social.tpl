<div class="auth-social">
	<div class="auth-social__divider"><span>{$googleOrContinue|escape}</span></div>
	<a href="{$googleStartUrl|escape}" class="auth-social__btn auth-social__btn--google">
		...
		<span>{$googleButtonLabel|escape}</span>
	</a>
</div>
