<div class="admin-panel ai-dash-panel mb-4" id="aiDashboardPanel">
	<div class="d-flex flex-wrap align-items-start justify-content-between gap-2 mb-2">
		<div>
			...
			<p class="small text-muted mb-0">Satışlar, çok satan ürünler ve aksiyon önerileri</p>
		</div>
		{if $configured}
	...
	<p class="small mb-2" id="aiDashStatus"></p>
	<div id="aiDashResult" class="ai-dash-result small"></div>
</div>
